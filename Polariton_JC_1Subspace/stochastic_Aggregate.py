...
def do_STOCHASTIC_DOS():
    ...
    for pt in range( NPTS ): # SHOULD WE PARALLIZE THIS ? THIS IS THE MOST TIME-CONSUMING PART
        ...
        T0 = time()
        DOS[pt,:] = do_Stochastic_Chebyshev( DOS[pt,:], c_l, N, EGS, E, pt, MU, WC, A0_SCALED, dH, E0, M, P )
...
def do_Stochastic_Chebyshev( DOS, c_l, N, EGS, E, pt, MU, WC, A0_SCALED, dH, E0, M, P ):
    for _ in range( N_STOCHASTIC ):
        ...
        v0, v1, DOS = get_T0_T1_vec( DOS, pt, c_l, N, EGS, E, MU, WC, A0_SCALED, dH, E0, r_vec, M, P )
...
def get_T0_T1_vec( DOS, pt, c_l, N, EGS, E, MU, WC, A0_SCALED, dH, E0, r_vec, M, P ):
    v0 = r_vec
